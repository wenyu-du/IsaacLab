...
from .new_temp_task_marl_env_cfg import NewTempTaskMarlEnvCfg


class NewTempTaskMarlEnv(DirectMARLEnv):
    cfg: NewTempTaskMarlEnvCfg

    def __init__(self, cfg: NewTempTaskMarlEnvCfg, render_mode: str | None = None, **kwargs):
